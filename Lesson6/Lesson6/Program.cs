...
public delegate double Funny(double x, double a);
...
class Program
{
    ...
    public static void Table(Funny F, double x, double b)
    {
        double a =  3;
        Console.WriteLine("----- X ----- Y -----");
        while (x <= b)
    ...
    public static double MyFunction (double x, double a)
    {
        return a*(x*x);
    }
    ...
    static void Main()
    {
        ...
        Table(new Funny(MyFunction), -2, 3);
        Table(new Funny(sin), -2, 3);
